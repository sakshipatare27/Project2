...
<body>
	...
	<header>
    <nav class="navbar navbar-expand-md navbar-dark" style="background-color: Pink; justify-content: center;">
        <ul class="navbar-nav">
            <li>
                <a href="<%=request.getContextPath()%>/list" class="nav-link" style="color: black;">List of Students</a>
            </li>
        </ul>
    </nav>
</header>
